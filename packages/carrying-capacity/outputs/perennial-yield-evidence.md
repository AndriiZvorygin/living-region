# Perennial yield and establishment evidence
...
|---|---:|---:|---:|---:|---:|---|
| Raspberry and berry shrub layer | 2 | 3 | 3 | 3 t/ha | 6.7 GJ/ha | central synthesis |
| Currant and gooseberry shrubs | 3 | 4 | 5 | n/a t/ha | n/a | reference only |
| Hazelnut | 5 | 8 | 11 | 0.75 t/ha | 19.7 GJ/ha | central synthesis |
| Apple and pear layer | 4 | 8 | 12 | 4 t/ha | 8.7 GJ/ha | diversity-only central sensitivity |
| Chinese chestnut | 8 | 12 | 15 | 0.75 t/ha | 7.0 GJ/ha | central synthesis |
| Heartnut/Japanese walnut | 6 | 10 | 18 | n/a t/ha | n/a | reference only |
| White oak/acorn systems | not established | not established | n/a | n/a t/ha | n/a | reference only |
| Perennial vegetables | 1 | 3 | 5 | n/a t/ha | n/a | reference only |
...
- **Hazelnut:** [source](https://www.mdpi.com/2071-1050/17/4/1543) (2025; measured Ontario on-farm trial; short series). Fertility treatments and cultivar/site performance are being measured in Ontario, strengthening the evidence base without establishing a Grey-Bruce low-input mature yield. **Model action:** retain the existing conservative planning synthesis; do not promote to a measured canonical yield.
- **White oak/acorn systems:** [source](https://research.fs.usda.gov/treesearch/36770) (2009; measured comparable-climate forest study; high inter-tree and year variability). Acorn production can be measured but is strongly episodic and uneven among trees and sites. **Model action:** retain research-only status; do not credit acorn calories to the central mix.
- **Chinese chestnut:** [source](https://ucanr.edu/site/fruit-nut-research-information-center/chestnut-fact-sheet) (extension reference; comparable-climate extension production guidance). Supports the crop function and orchard establishment context, but does not provide a Grey-Bruce low-input yield series. **Model action:** retain the conservative unvalidated synthesis and its climate, blight, frost and wildlife caveats.
- **Heartnut/Japanese walnut:** [source](https://omafra.gov.on.ca/CropOp/en/spec_fruit/nuts/hear.html) (Ontario reference; Ontario specialty-crop reference without a yield series). Supports a possible food-tree role and bearing-time investigation, not a defensible local hectare yield. **Model action:** retain reference-only status pending regional trials.
