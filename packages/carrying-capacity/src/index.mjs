...
export {NUTRITION_CONTRACT_VERSION, DAYS_PER_YEAR, NUTRIENT_DEFINITIONS, FOOD_PORTFOLIO, NUTRITION_GOAL_DEFINITIONS, HEALTH_CANADA_NUTRIENT_DRI_SOURCE, HEALTH_CANADA_AMINO_ACID_PATTERN_SOURCE, CANADIAN_NUTRIENT_FILE_SOURCE, FOOD_NUTRIENT_PROFILES, HEALTH_CANADA_AMINO_ACID_PATTERN, calculateHealthCanadaNutrientDemand, calculateFoodNutrientAdequacy, calculateFoodPortfolioLand, calculateFoodSuccessionLedger} from './nutrition.mjs';
...
export {calculatePerennialMixTimeline, calculatePerennialFoodProductionLedger} from './perennial.mjs';
...
export {LIVESTOCK_CONTRACT_VERSION, CANONICAL_HOUSEHOLD_FAE, LIVESTOCK_SCALING_BASIS, LIVESTOCK_LABOUR_SCALING_METHOD, LIVESTOCK_LABOUR_SCALING_FORMULA, LIVESTOCK_LABOUR_SCALING_NOTE, LIVESTOCK_LABOUR_TASKS, LIVESTOCK_FEED_STREAMS, LIVESTOCK_SPECIES, MINIMUM_SELF_REPLACING_SYSTEMS, CHICKEN_BREED_CANDIDATES, CHICKEN_SYSTEM_COMPARISON, LIVESTOCK_RATION_SCENARIOS, PROPERTY_FEED_SUPPLY_RULES, derivePropertyFeedSupply, deriveLivestockScale, deriveLivestockSystemCount, calculateFeedLedger, calculateLivestockLabour, calculateLivestockReproductiveLedger, calculateLivestockScenario, calculateMinimumSelfReplacingLivestockSystem, findMinimumPropertyB12Scale, calculateNutrientFoodSystem, compareNutrientFoodSystems} from './livestock.mjs';
...
export {HOUSE_COST_CONTRACT_VERSION, HOUSE_COST_EVIDENCE, HOUSE_COST_MODEL_ID, HOUSE_COST_PRICING_LAYERS, MIN_RESIDENTIAL_DIAMETER_M, MAX_RESIDENTIAL_DIAMETER_M, calculateYurtGeometry, calculateOccupancyCompliance, calculateHouseCost, buildHouseCostPresentationContract, buildArcDwellingAffordabilityIntegration} from './house-cost.mjs';
export {HOUSE_MORTGAGE_CONTRACT_VERSION, HOUSE_MORTGAGE_RATE_EVIDENCE, HOUSE_MORTGAGE_SCENARIOS, isMortgageRateSnapshotStale, validateMortgageRateSnapshot, minimumMortgageDownPayment, mortgageInsurancePremium, mortgagePayment, mortgageBalance, calculateMortgage, calculateMortgageScenarios} from './mortgage.mjs';
export {ARC_LAND_MARKET_CONTRACT_VERSION, ARC_LAND_MARKET_SOURCES, ARC_LAND_SIZE_BANDS, DEFAULT_ARC_LAND_MARKET_DATA, buildLandMarketContract, classifyLandSize, estimateLandPriceForParcel, getArcAcquisitionObservation, landMarketDataPath, loadArcLandMarketData, normalizeLandObservation, parseLandObservationCsv, summarizeLandObservations} from './land-market.mjs';
export {ARC_ADULT_SCALE_SCENARIOS, ARC_ADULT_SCALE_CROSSOVER_SCENARIOS, ARC_FAMILY_CAPACITY_STANDARD, buildArcAdultScalePresentationContract, buildArcAdultScaleScenarios, calculateArcPropertyAcquisitionScenario} from './arc-community-scale.mjs';
...
export {FOOD_PRODUCTION_LABOUR_CONTRACT_VERSION, LABOUR_WEEKS_PER_YEAR, LABOUR_CAPACITY_THRESHOLDS, LABOUR_PROJECTION_MODE, LABOUR_MECHANIZATION_ASSUMPTION, LABOUR_CATEGORIES, CLOSED_LOOP_WORK_ITEMS, LABOUR_PROFILE_BY_PRODUCTION_ID, calculateFoodProductionLabour, compareFoodLabourCapacity} from './production-labour.mjs';
