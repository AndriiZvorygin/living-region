...
|---|---:|---:|---:|
| 1 adult | ${f(row('favourable', 'one_adult').robust_household_minimum_area_ha, 2)} ha min / ${f(row('favourable', 'one_adult').gross_site_area_ha, 2)} ha with surplus | ${f(row('ordinary', 'one_adult').robust_household_minimum_area_ha, 2)} ha min / ${f(row('ordinary', 'one_adult').gross_site_area_ha, 2)} ha with surplus | ${f(row('marginal', 'one_adult').robust_household_minimum_area_ha, 2)} ha min / ${f(row('marginal', 'one_adult').gross_site_area_ha, 2)} ha with surplus |
| 1 adult + 1 child | ${f(row('favourable', 'adult_plus_child').robust_household_minimum_area_ha, 2)} ha min / ${f(row('favourable', 'adult_plus_child').gross_site_area_ha, 2)} ha with surplus | ${f(row('ordinary', 'adult_plus_child').robust_household_minimum_area_ha, 2)} ha min / ${f(row('ordinary', 'adult_plus_child').gross_site_area_ha, 2)} ha with surplus | ${f(row('marginal', 'adult_plus_child').robust_household_minimum_area_ha, 2)} ha min / ${f(row('marginal', 'adult_plus_child').gross_site_area_ha, 2)} ha with surplus |
| 2 adults | ${f(row('favourable', 'two_adults').robust_household_minimum_area_ha, 2)} ha min / ${f(row('favourable', 'two_adults').gross_site_area_ha, 2)} ha with surplus | ${f(row('ordinary', 'two_adults').robust_household_minimum_area_ha, 2)} ha min / ${f(row('ordinary', 'two_adults').gross_site_area_ha, 2)} ha with surplus | ${f(row('marginal', 'two_adults').robust_household_minimum_area_ha, 2)} ha min / ${f(row('marginal', 'two_adults').gross_site_area_ha, 2)} ha with surplus |
| 2 adults + 1 child | ${f(row('favourable', 'two_adults_plus_one_child').robust_household_minimum_area_ha, 2)} ha min / ${f(row('favourable', 'two_adults_plus_one_child').gross_site_area_ha, 2)} ha with surplus | ${f(row('ordinary', 'two_adults_plus_one_child').robust_household_minimum_area_ha, 2)} ha min / ${f(row('ordinary', 'two_adults_plus_one_child').gross_site_area_ha, 2)} ha with surplus | ${f(row('marginal', 'two_adults_plus_one_child').robust_household_minimum_area_ha, 2)} ha min / ${f(row('marginal', 'two_adults_plus_one_child').gross_site_area_ha, 2)} ha with surplus |
| 2 adults + 2 children | ${f(row('favourable', 'two_adults_plus_two_children').robust_household_minimum_area_ha, 2)} ha min / ${f(row('favourable', 'two_adults_plus_two_children').gross_site_area_ha, 2)} ha with surplus | ${f(row('ordinary', 'two_adults_plus_two_children').robust_household_minimum_area_ha, 2)} ha min / ${f(row('ordinary', 'two_adults_plus_two_children').gross_site_area_ha, 2)} ha with surplus | ${f(row('marginal', 'two_adults_plus_two_children').robust_household_minimum_area_ha, 2)} ha min / ${f(row('marginal', 'two_adults_plus_two_children').gross_site_area_ha, 2)} ha with surplus |
| 2 adults + 3 children | ${f(row('favourable', 'two_adults_plus_three_children').robust_household_minimum_area_ha, 2)} ha min / ${f(row('favourable', 'two_adults_plus_three_children').gross_site_area_ha, 2)} ha with surplus | ${f(row('ordinary', 'two_adults_plus_three_children').robust_household_minimum_area_ha, 2)} ha min / ${f(row('ordinary', 'two_adults_plus_three_children').gross_site_area_ha, 2)} ha with surplus | ${f(row('marginal', 'two_adults_plus_three_children').robust_household_minimum_area_ha, 2)} ha min / ${f(row('marginal', 'two_adults_plus_three_children').gross_site_area_ha, 2)} ha with surplus |
...
7. For an ordinary mesic site, the solved canonical mature plants-only household minimum is **${f(transition.mature_food_system.canonical_rows.find(row => row.site === 'ordinary_mesic' && row.household === 'one_adult').robust_household_minimum_area_ha, 2)} ha** for one adult, or **${f(transition.mature_food_system.canonical_rows.find(row => row.site === 'ordinary_mesic' && row.household === 'one_adult').gross_site_area_ha, 2)} ha** including the residual optional market target. Two adults plus two representative children require **${f(transition.mature_food_system.canonical_rows.find(row => row.site === 'ordinary_mesic' && row.household === 'two_adults_plus_two_children').robust_household_minimum_area_ha, 2)} ha** minimum and **${f(transition.mature_food_system.canonical_rows.find(row => row.site === 'ordinary_mesic' && row.household === 'two_adults_plus_two_children').gross_site_area_ha, 2)} ha** with the optional target; two adults plus three children require **${f(transition.mature_food_system.canonical_rows.find(row => row.site === 'ordinary_mesic' && row.household === 'two_adults_plus_three_children').gross_site_area_ha, 2)} ha**. The earlier mathematical minimum and pre-ageing robust results remain in the baseline comparison outputs.
