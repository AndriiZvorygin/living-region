...
function buildSensitivityRows(context) {
  ...
  const defs = [
    {
      ...
      dieselPriceMultiplier: 1.0,
      fertilizerAvailabilityIndex: 1.0,
      fertilizerPriceMultiplier: 1.0,
      machinerySupportFactor: 1.0,
      transportFuelAvailabilityIndex: 1.0,
      labourProductivityFactor: 1.0,
    ...
    },
    {
      ...
      fuelAvailabilityIndex: 0.98,
      dieselPriceMultiplier: 1.05,
      fertilizerAvailabilityIndex: 0.98,
      fertilizerPriceMultiplier: 1.06,
      machinerySupportFactor: 0.98,
      transportFuelAvailabilityIndex: 0.98,
      labourProductivityFactor: 0.95,
    ...
    },
    {
      ...
      fuelAvailabilityIndex: 0.85,
      dieselPriceMultiplier: 1.35,
      fertilizerAvailabilityIndex: 0.88,
      fertilizerPriceMultiplier: 1.30,
      machinerySupportFactor: 0.82,
      transportFuelAvailabilityIndex: 0.86,
      labourProductivityFactor: 0.75,
    ...
    },
    {
      ...
      fuelAvailabilityIndex: 0.70,
      dieselPriceMultiplier: 1.75,
      fertilizerAvailabilityIndex: 0.75,
      fertilizerPriceMultiplier: 1.65,
      machinerySupportFactor: 0.62,
      transportFuelAvailabilityIndex: 0.72,
      labourProductivityFactor: 0.58,
    ...
    },
    {
      ...
      fossilInputSupport: 'low',
      supplyChainDependence: 'low-moderate',
      fuelAvailabilityIndex: 0.68,
      dieselPriceMultiplier: 1.82,
      fertilizerAvailabilityIndex: 0.72,
      fertilizerPriceMultiplier: 1.72,
      machinerySupportFactor: 0.58,
      transportFuelAvailabilityIndex: 0.70,
      labourProductivityFactor: 0.64,
    ...
    },
    {
      ...
      supplyChainDependence: 'moderate',
      fuelAvailabilityIndex: 0.82,
      dieselPriceMultiplier: 1.42,
      fertilizerAvailabilityIndex: 0.86,
      fertilizerPriceMultiplier: 1.32,
      machinerySupportFactor: 0.78,
      transportFuelAvailabilityIndex: 0.84,
      labourProductivityFactor: 0.84,
  ...
  for (const d of defs) {
    ...
    rows.push({
      ...
      labourRequiredFTE,
      foodWorkersNeededFTE: labourRequiredFTE,
      labourAvailableFTE,
      lossShare: p.lossShare,
      fuelAvailabilityIndex: d.fuelAvailabilityIndex,
      dieselPriceMultiplier: d.dieselPriceMultiplier,
      fertilizerAvailabilityIndex: d.fertilizerAvailabilityIndex,
      fertilizerPriceMultiplier: d.fertilizerPriceMultiplier,
      transportFuelAvailabilityIndex: d.transportFuelAvailabilityIndex,
      labourProductivityFactor: d.labourProductivityFactor,
      ...
      yieldMultiplier: p.grossFoodEnergyGJPerHa > 0 ? profileNet / p.grossFoodEnergyGJPerHa : 0,
      yieldPenalty: 1 - (p.grossFoodEnergyGJPerHa > 0 ? profileNet / p.grossFoodEnergyGJPerHa : 0),
      humanFoodPriorityHa,
...
export function buildGreyFoodSystemCalibration(options = {}) {
  ...
  const report = {
    ...
    scenarioAssumptions: Object.fromEntries(
      sensitivityRows.map((r) => [r.scenario, {
        fuelAvailabilityIndex: r.fuelAvailabilityIndex,
        dieselPriceMultiplier: r.dieselPriceMultiplier,
        fertilizerAvailabilityIndex: r.fertilizerAvailabilityIndex,
        fertilizerPriceMultiplier: r.fertilizerPriceMultiplier,
        machinerySupportFactor: r.machinerySupportFactor,
        transportFuelAvailabilityIndex: r.transportFuelAvailabilityIndex,
        inputConstraintFactor: r.inputConstraintFactor,
        labourProductivityFactor: r.labourProductivityFactor,
        yieldMultiplier: r.yieldMultiplier,
        yieldPenalty: r.yieldPenalty,
        lossShare: r.lossShare,
        candidateFoodHa: r.candidateFoodHa,
        humanFoodPriorityHa: r.humanFoodPriorityHa,
        netGJPerHa: r.netGJPerHa,
        foodWorkersNeededFTE: r.foodWorkersNeededFTE,
  ...
  fs.writeFileSync(sensitivityCsvPath, toCsv(sensitivityRows, [
    'scenario','yieldProfile','fuelAvailabilityIndex','dieselPriceMultiplier','fertilizerAvailabilityIndex','fertilizerPriceMultiplier',
    'machinerySupportFactor','transportFuelAvailabilityIndex','inputConstraintFactor','labourProductivityFactor',
    'yieldMultiplier','yieldPenalty','lossShare','candidateFoodHa','humanFoodPriorityHa','netGJPerHa','netFoodEnergyGJ',
    'foodCoverage','foodSurplusGJ','foodWorkersNeededFTE','requiredHaForSelfCoverage',
    'shareOfCandidateLandRequired','labourRequiredFTE','labourAvailableFTE','candidateLandShare',
  ...
  const markdown = [
    ...
    '',
    '## Scenario assumptions (explicit parameters)',
    ...
    '|---|---:|---:|---:|---:|---:|---:|---:|---|',
    ...sensitivityRows.map((r) => `| ${r.scenario} | ${r.fuelAvailabilityIndex.toFixed(2)} | ${r.fertilizerAvailabilityIndex.toFixed(2)} | ${r.machinerySupportFactor.toFixed(2)} | ${r.transportFuelAvailabilityIndex.toFixed(2)} | ${r.netGJPerHa.toFixed(2)} | ${r.foodCoverage.toFixed(3)} | ${r.foodWorkersNeededFTE.toFixed(2)} | ${r.interpretation} |`),
    '',
