...
const markdown = [
  ...
  '',
  `- Common-property land holding share: **$${money(decomposition.common_property_land_holding_share_monthly_cad)}/month**, allocated equally across the 12-household project. The legal-minimum default uses the conceptual lane/terminal-loop/250 m² amenity geometry; actual access, setback, drainage, buffer and common land must replace this prototype in a parcel/site-plan takeoff.`,
