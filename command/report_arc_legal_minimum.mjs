...
const classification = [
  ...
  {expense: 'Water supply', current_amount: 'centralized scenario placeholder', legal_requirement: 'potable/fire water required', financing_requirement: 'site-specific', physical_necessity: 'yes', optional: 'centralization optional', treatment: '$0 shared cash; distributed servicing capital/operating cost remains outside this charge and must be approved', basis: 'O. Reg. 517/06 s. 31; Ontario rural servicing guidance'},
  {expense: 'Sewage/greywater', current_amount: 'centralized scenario placeholder', legal_requirement: 'lawful sewage handling required', financing_requirement: 'site-specific', physical_necessity: 'yes', optional: 'centralization optional', treatment: '$0 shared cash; distributed system remains outside this charge and must be approved', basis: 'O. Reg. 517/06 s. 35; Building Code'},
  {expense: 'Electrical distribution', current_amount: 'centralized scenario placeholder', legal_requirement: 'safe electrical service/building compliance', financing_requirement: 'site-specific', physical_necessity: 'yes', optional: 'centralization optional', treatment: '$0 shared cash; dwelling/site connection remains outside this charge', basis: 'O. Reg. 517/06 s. 36; Building Code/ESA'},
...
const json = {
  ...
  scope: 'Minimum recurring cash for a legally and physically operable leased productive site; private dwelling and household expenses excluded.',
